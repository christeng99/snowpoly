...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Flash Crash Strategy for Polymarket 5-minute markets"
    )
    parser.add_argument(
        "--coin",
        type=str,
    ...
    print(f"{Colors.BOLD}  Flash Crash Strategy - {strategy_config.coin} 5-Minute Markets{Colors.RESET}")
