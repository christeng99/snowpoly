"""
Flash Crash Strategy - Volatility Trading for 5-Minute Markets

This strategy monitors 5-minute Up/Down markets for sudden probability drops
...
class FlashCrashStrategy(BaseStrategy):
    ...
    Monitors 5-minute markets for sudden price drops and trades
